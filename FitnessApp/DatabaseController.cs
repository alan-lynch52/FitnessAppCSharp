...
namespace FitnessApp
{
    class DatabaseController
    {
        ...
        public static string BODYWEIGHT_RECORD_LIST = "bodyweightRecords";
        public static string CALORIE_RECORD = "CalorieRecord";
        public static string CALORIE_RECORD_LIST = "calorieRecords";
        public static string EXERCISE = "Exercise";
        public static string EXERCISE_LIST = "exercises";
        public static string EXERCISE_RECORD = "ExerciseRecord";
        public static string EXERCISE_RECORD_LIST = "exerciseRecords";
        ...
        static void Main() {
            ...
            bool loggedIn = dc.Login("test1","pass");
